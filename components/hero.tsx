...
export default function Hero() {
  ...
  return (
    <section
      id="à propos"
      className="relative overflow-hidden bg-gradient-to-b from-emerald-50 to-white py-20 md:py-32"
    >
      ...
      <div className="absolute left-1/2 top-1/4 h-32 w-32 -translate-x-1/2 rounded-full bg-emerald-200 opacity-20 blur-2xl"></div>

      <div className="container relative mx-auto px-4">
        <div className="mx-auto max-w-4xl text-center">
          <h1
            className={`mb-6 text-4xl font-bold tracking-tight text-gray-900 transition-all duration-1000 md:text-6xl ${
          ...
          <p
            className={`mx-auto mb-10 max-w-2xl text-gray-600 transition-all duration-1000 delay-300 ${
              isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          >
          ...
          >
            <Button
              ...
              className="group flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-purple-600 transition-all duration-300 hover:from-emerald-700 hover:to-purple-700"
            >
              Voir mon parcours
